...
public class WelcomeController {
	...
	//
	public String home(ModelMap model, @RequestParam(value="q",required=false)String q ,@RequestHeader("Accept-Encoding") String encoding
				){
		String view="home";
		...
		model.addAttribute("name", "Sudhakar");		
